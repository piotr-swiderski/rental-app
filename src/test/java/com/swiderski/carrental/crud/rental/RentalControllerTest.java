...
class RentalControllerTest {
    ...
    void getAvailableCars_shouldReturnedPageOfAvailableCars() throws Exception {
        ...
        when(rentService.getAvailableCars(any(PageRequest.class))).thenReturn(getCarPage());
    ...
    void getRentedCars_shouldReturnedPageOfRentedCars() throws Exception {
        ...
        when(rentService.getRentedCars(any(PageRequest.class))).thenReturn(getCarPage());
